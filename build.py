...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.omnipax.testflightsdk.js')
	...
	f = os.path.join(cwd,'Classes','ComOmnipaxTestflightsdkModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.omnipax.testflightsdk.js']
